...
class Config:
    ...
    # STEP 1 - Data paths
    ORTHO_FOLDER = 'data/ortho'  # Folder with .tif orthomosaics
    POLY_FOLDER = 'data/geojson'  # Folder with crown polygon GeoJSONs
    STEP1_OUTPUT = 'output/step1_output'  # Step 1 outputs
    ...
    STEP2_OUTPUT = 'output/step2_output'  # Step 2 outputs
    
    # STEP 3 - Validation (optional)
    GROUND_TRUTH_CSV = 'data/ground_truth'
    # GROUND_TRUTH_CSV = 'data/labeling_sheet.csv'  # optional CSV-style ground truth
    STEP3_VALIDATION_OUTPUT = None  # Auto-set if not specified
    
    # STEP 4 - KMZ export
    STEP4_OUTPUT = 'output/step4_output'  # KMZ output folder
